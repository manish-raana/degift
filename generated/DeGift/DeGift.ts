...
export class DeGift__getGiftDetailsResultValue0Struct extends ethereum.Tuple {
  get sender(): Address {
...
export class DeGift__giftCardsResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class DeGift extends ethereum.SmartContract {
  static bind(address: Address): DeGift {
    return new DeGift("DeGift", address);
  }

  getGiftDetails(_giftId: BigInt): DeGift__getGiftDetailsResultValue0Struct {
    ...
    return changetype<DeGift__getGiftDetailsResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getGiftDetails(
    _giftId: BigInt,
  ): ethereum.CallResult<DeGift__getGiftDetailsResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<DeGift__getGiftDetailsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  giftCards(param0: BigInt): DeGift__giftCardsResult {
    let result = super.call(
      "giftCards",
    ...
    return new DeGift__giftCardsResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_giftCards(param0: BigInt): ethereum.CallResult<DeGift__giftCardsResult> {
    let result = super.tryCall(
      "giftCards",
      "giftCards(uint256):(address,address,uint256,address,string,bool,uint8,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
